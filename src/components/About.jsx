            ...
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                <div className="col-span-2">
                    ...
                    <p className="py-2 text-[#464039]"> 
                        Hi! My name is Rocío Albani I graduated from Henry as a Full Stack Developer but 
                        ...
                        in the communications industry. This journey taught me spatially how to work in team to
                        accomplish what you propose the best way possible. 
                        </p>
                    <p className="py-2 text-[#464039]"> 
                        As a wed developer, I've met and collaborated with so many talented people to created amazing
                        projects and become a quick learner of new tech stacks as needed. Currently I'm learning about 
                        UI/UX design and Figma.</p>
                        <p className="py-2 text-[#464039]"> Languages: English and Spanish.</p>
                        <p className="py-2 text-[#464039]">
                        Skills: JavaScript(ES6+), HTML5, CSS, TypeScript, React.js, Redux, Redux Toolkit, Sass, Express,
                        Git, PostgreSQL, Sequelize, Node.js, Framer Motion, GitHub.</p>
                </div>
